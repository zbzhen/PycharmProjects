...
ax.arrow(-1.4, 0, 2.8, 0, head_width=0.08, head_length=0.1, fc='k', ec='k', overhang=0.8, lw=2)
ax.arrow(0, -1.4, 0, 2.8, head_width=0.08, head_length=0.1, fc='k', ec='k', overhang=0.8, lw=2)
...
plt.text(1.4, 0,r'$x$', color="black", fontsize=25, va='top', ha='left')
plt.text(0+h, 1.4,r'$y$', color="black", fontsize=25, va='center', ha='left')
...
# yy = xx*xx  # 二次
# yy = xx     # 一次
# yy = np.sqrt(xx*xx)  # 绝对值函数
# plt.plot(xx, yy, lw=4, color="blue")

# 反比例
xx = np.linspace(0.15, 1.3, 100)
yy = 0.2/xx
plt.plot(xx, yy, lw=4, color="blue")
xx = np.linspace(-0.15, -1.3, 100)
yy = 0.2/xx
...
plt.savefig("fanbili.png", dip=20)
plt.show()