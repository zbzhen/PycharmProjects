...
#静态界面（背景、色块等）
interface = pygame.image.load(r'1.png').convert()
gameover = pygame.image.load(r'2.png').convert()
...
#下一个方块预览图
surface_z_left = pygame.image.load(r'1.png').convert_alpha()
surface_z_right = pygame.image.load(r'1.png').convert_alpha()
surface_long = pygame.image.load(r'1.png').convert_alpha()
surface_cross = pygame.image.load(r'1.png').convert_alpha()
surface_rect = pygame.image.load(r'1.png').convert_alpha()
surface_l_left = pygame.image.load(r'1.png').convert_alpha()
surface_l_right = pygame.image.load(r'1.png').convert_alpha()
