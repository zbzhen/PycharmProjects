...
plt.plot(x,np.log(addmeshH_1)/np.log(10), "--d--",label="Rough problem meshH" , markersize=20, linestyle='dashed')
plt.plot(x,np.log(addmeshD_1)/np.log(10), "--*--",label="Rough problem meshD" , markersize=20, linestyle='dashed')
