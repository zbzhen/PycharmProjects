...
#axes.text(theta+0.03, 1-theta,"$(\\theta, 1-\\theta)$",fontsize = 20)
axes.text(theta, 1-theta+a*0.55,"$(0, 1)$",fontsize = ftz, verticalalignment='bottom', horizontalalignment='center')
axes.text(0, 0-a,"$(0,0)$",fontsize = ftz, verticalalignment='top', horizontalalignment='center')
axes.text(1, 0-a,"$(1,0)$",fontsize = ftz, verticalalignment='top', horizontalalignment='center')
axes.set_xticks([])
axes.set_yticks([])
...
plt.savefig("Ttheta0.pdf",dip=120)
plt.show()
#help(plt.plot)
